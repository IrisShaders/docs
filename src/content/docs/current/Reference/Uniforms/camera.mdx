...
## vehicleLookVector <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
...
## relativeVehiclePosition <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
