...
| [isElytraFlying](/current/reference/uniforms/status/#isElytraFlying)           | bool  | true / false  | Whether the player is currently flying with an elytra          | <Badge text="Iris Exclusive" variant="tip"/>         |
