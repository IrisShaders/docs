...
| [relativeVehiclePosition](/current/reference/uniforms/camera/#relativevehicleposition)         | vec3  |              | World space offset from the current vehicle to the camera          | <Badge text="Iris Exclusive" variant="tip"/> |
