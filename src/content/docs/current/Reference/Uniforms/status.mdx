...
## vehicleInWater <Badge text="Iris Exclusive" variant="tip" size="medium" />
```glsl
...
## isRiding <Badge text="Iris Exclusive" variant="tip" size="medium" />
```glsl
...
## inSwimmingAnimation <Badge text="Iris Exclusive" variant="tip" size="medium" />
```glsl
...
## feetInWater <Badge text="Iris Exclusive" variant="tip" size="medium" />
```glsl
