...
## vehicleInWater <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
...
## isRiding <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
...
## inSwimmingAnimation <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
...
## feetInWater <Badge text="Iris 1.10.4+ Exclusive" variant="tip" size="medium" />
```glsl
...
## isElytraFlying <Badge text="Iris 1.10.6+ Exclusive" variant="tip" size="medium" />
```glsl
